...
class Game:
        ...
        for row in range(ROWS):
            for col in range(COLS):
                ...
                if col == 0:
                    ...
                    # Position the label at the left edge of the square, centered vertically.
                ...
                if row == 7:
                    ...
                    # Position the label at the bottom edge of the square, centered horizontally.
    ...
    def show_moves(self, surface):
        ...
        if self.dragger.dragging:
            ...
            for move in piece.moves:
                ...
                # Determine the rectangle for the square to highlight
                rect = (
    ...
    def show_last_move(self, surface):
        ...
        theme = self.config.theme
        # Only highlight the last move if there is one
        if self.board.last_move:

            initial = self.board.last_move.initial
            final = self.board.last_move.final
            # Highlight both the initial and final squares of the last move
